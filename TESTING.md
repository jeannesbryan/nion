...
## NiOn 2.1.0 Stage 2 — Escape Guards
...
## NiOn 2.1.0 Stage 1 — Security Levels
...
```bash
./scripts/test-appimage.sh dist/NiOn-2.1.0-x86_64.AppImage
cd dist
sha256sum -c NiOn-2.1.0-x86_64.AppImage.sha256
```
